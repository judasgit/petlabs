...
<div class="seccion-catalogo">
    ...
    <div class="row">
        ...
        <div class="col-3"><h1>Nuevo Producto</h1></div>
    </div>
    @if ($errors->any())
        ...
        <div class="row justify-content-center">
            <div class="col-6">
                <div class="mb-3">
                    ...
                    <input value="{{ old('nombre') }}" type="text" class="form-control" id="nombre" name="nombre" aria-describedby="nombreHelp" required>
                    <div id="nombreHelp" class="form-text">Nombre del producto.</div>
                </div>
                <div class="mb-3">
                    <label for="descripcion" class="form-label">Descripción</label>
                    <input value="{{ old('descripcion') }}" type="text" class="form-control" id="descripcion" name="descripcion" aria-describedby="descripcionHelp" required>
                    <div id="descripcionHelp" class="form-text">Descripción completa del producto.</div>
                </div>
                <div class="row mb-3">
                    <div class="col-3">
                        <label for="cantidad" class="form-label">Cantidad</label>
                        <input value="{{ old('cantidad') }}" type="number" class="form-control" id="cantidad" name="cantidad" aria-describedby="cantidadHelp" required>
                        <div id="cantidadHelp" class="form-text">Cantidad de existencias del producto.</div>
                    </div>
                    <div class="col-3">
                        <label for="precio" class="form-label">Precio</label>
                        <input value="{{ old('precio') }}" type="text" class="form-control" id="precio" name="precio" aria-describedby="precioHelp" required>
